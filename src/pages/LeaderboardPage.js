...
export default function LeaderboardPage() {
  ...
  async function assignRandomTaskToCouple(coupleId) {
    ...
    const tasks = [
      ...
      "Эрэгтэй нь эмэгтэйгээ гэрээс нь очиж аваад хамт алхаад нэг нэгнийхээ дуртай юмыг асуухгүйгээр мэдээд нэгэндээ бэлэглэх.",
      ...
      "Нэгэнтэйгээ 1 цаг ярингаа нэгэнийхээ хувцуудыг хараад ямар хувцас өмсөхийн заах. Тэгээд хоёр үнэн нэг худал тоглох."
    ];
